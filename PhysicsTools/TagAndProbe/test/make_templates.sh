...
python MCTemplates/getTemplatesFromMC.py -i current/TnPTree_mc_norm.root -o ../data/MVATightElectronToMulti_crack.root -d MVATightElectronToIso --probeTauVarName=probe_dRTau --tagTauVarName=tag_Ele_dRTau --idprobe=passingMultiIso --var1Name=probe_Ele_et --var1Bins=10,20,30,40,50,200 --var2Name=probe_sc_eta --var2Bins=1.442,1.566 &
python MCTemplates/getTemplatesFromMC.py -i current/TnPTree_mc_norm.root -o ../data/MVATightElectronToMultiEmu_crack.root -d MVATightElectronToIso --probeTauVarName=probe_dRTau --tagTauVarName=tag_Ele_dRTau --idprobe=passingMultiIsoEmu --var1Name=probe_Ele_et --var1Bins=10,20,30,40,50,200 --var2Name=probe_sc_eta --var2Bins=1.442,1.566 &
...
python MCTemplates/getTemplatesFromMC.py -i current/TnPTree_mc_norm.root -o ../data/MVATightElectronToMulti_alleta.root -d MVATightElectronToIso --probeTauVarName=probe_dRTau --tagTauVarName=tag_Ele_dRTau --idprobe=passingMultiIso --var1Name=probe_Ele_et --var1Bins=10,20,30,40,50,200 --var2Name=probe_sc_eta --var2Bins=0,2.5 &
python MCTemplates/getTemplatesFromMC.py -i current/TnPTree_mc_norm.root -o ../data/MVATightElectronToMultiEmu_alleta.root -d MVATightElectronToIso --probeTauVarName=probe_dRTau --tagTauVarName=tag_Ele_dRTau --idprobe=passingMultiIsoEmu --var1Name=probe_Ele_et --var1Bins=10,20,30,40,50,200 --var2Name=probe_sc_eta --var2Bins=0,2.5 &
