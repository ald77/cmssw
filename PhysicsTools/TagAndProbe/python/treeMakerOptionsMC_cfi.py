...
options['TnPPATHS']                = cms.vstring("HLT_Ele27_eta2p1_WP75_Gsf_v*")
options['TnPHLTTagFilters']        = cms.vstring("hltEle27WP75GsfTrackIsoFilter")
options['TnPHLTProbeFilters']      = cms.vstring("hltEle27WP75GsfTrackIsoFilter")#really want this off, but not sure how
...
options['MAXEVENTS']               = cms.untracked.int32(50000) 
